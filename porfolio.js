...
projects.push(projectClass("TikTokPets", "./assets/tiktok.png", "Mobile friendly website that fetches two random Tiktok videos and displays them on the site. Users rate the videos with a heart. The ratings define their preferences by implementation of the pagerank algorithm. Replit no longer allows hosting so I removed the link to the working version however the code is still on GitHub.", "", "https://github.com/WilliamNorboe/Tiktok-Pets"));
